...
public class SignUpPage {
    ...
    public SignUpPage setDay(String day){
        ...
        new WebDriverWait(driver, 5).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(dayDropDownOption, day)))).click();
        return this;
    }
    ...
    public SignUpPage setMonth(String month){
        ...
        new WebDriverWait(driver, 5).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(monthDropDownOption,month)))).click();
        return this;
    }
    ...
    public SignUpPage setYear(String year) {
        ...
        new WebDriverWait(driver, 5).until(ExpectedConditions.visibilityOfElementLocated
                (By.xpath(String.format(yearDropDownOption, year)))).click();
        return this;
    }
